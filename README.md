...
# 📖 [MorseCode decoder] <a name="about-project"></a>


**[MorseCode Decoder]** is an app written in ruby for decoding morse code. It takes in your morse code and returns our message in the English language
...
- [ ] Take in ruby message
- [ ] Return message in English language
...
```sh
  git clone https://github.com/martinkarugaba/decode-morse-code
```
